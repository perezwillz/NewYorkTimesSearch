...
class NetworkManager{
    ...
    static func fetchReviews(completion: @escaping (Data?, NetworkManager.Errors?) -> Void) {
        makeRequest(method: .get, baseURLString: .url, queries: ["query" : .searchValue, "api-key" : .apiKey], completion: completion)
    }
